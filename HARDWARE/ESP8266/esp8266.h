...
#define ESP8266_RST_Pin_Periph_Clock  RCC_AHB1Periph_GPIOA       //复位时钟

#define ESP8266_CH_PD_Pin     GPIO_Pin_5   //使能管脚
#define ESP8266_CH_PD_Pin_Port     GPIOA   //使能端口
#define ESP8266_CH_PD_Pin_Periph_Clock  RCC_AHB1Periph_GPIOA                     //使能时钟
...
#define CLOCKS_PER_SEC 1500000 //25m
#define CLOCKS3_PER_SEC 600000
#define CLOCKS4_PER_SEC 300000
...
//MQTT功能函数
bool ESP8266_MQTTUSERCFG( char * pNULL, char * pUserName,char * PassWord);
